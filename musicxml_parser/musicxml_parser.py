...
# reSearchChords = re.compile(r'[A-G][#b]?_(dom|maj|min|hdim|dim|aug|7|fdim)[467]?_[012]', re.IGNORECASE)
# reSearchChords = re.compile(r'[[A-G][#b]?:(minmaj|maj|min|hdim|dim|aug|7)[^\s]*', re.IGNORECASE)
